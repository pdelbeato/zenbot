...
c.name = 'Test QuantumBot Binance BTC'

// mongo configuration
c.mongo = {}
c.mongo.db = 'quantumbot_test'
...
c.selector = 'binance.BTC-TUSD'
//c.selector = 'kraken.XXBT-ZEUR'

//	Strategies
c.strategy = {}

//Every strategy must be in the form of:
...
//flag to activate long position
c.active_long_position = false
//flag to activate short position
c.active_short_position = false
//Flag to deactivate hold check
c.no_check_hold = false

// Order execution rules:

//period length for operating
c.period_length = '1m'
// avoid trading at a slippage above this pct
c.max_slippage_pct = 0.1
// Quantum size
c.quantum_value = 250
//Max number of opened positions
c.max_positions = 10
//avoid selling at a profit below this pct (for long positions).
c.sell_gain_pct = 1
//avoid buying at a profit below this pct (for short positions).
c.buy_gain_pct = 1
//accumulate a buy/sell_gain_pct of asset
c.accumulate = false
//time to wait after a buy (minutes)
c.buy_calmdown = 16
//time ti wait after a sell (minutes)
c.sell_calmdown = 16
...
c.cancel_after = 'day'
// Sending update message every <hours> hours
//c.update_msg = 4 
...
//// Notifiers:
//c.notifiers = {}
//c.notifier_lvl = 9 //(0=status message, 5=operations, 9=everything)
//
//// xmpp config
//c.notifiers.xmpp = {}
...
//c.notifiers.telegram.bot_token = 'YOUR-API-TOKEN'
//c.notifiers.telegram.chat_id = 'YOUR-CHAT-ID' // the id of the chat the messages should be send in
//c.notifiers.telegram.chat_id_master = '7YOUR-CHAT-ID-MASTER' // the id of the chat of master the messages should be send in
