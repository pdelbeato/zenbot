...
let max_fc_width = 0
module.exports = {
  formatAsset: function formatAsset (amt, asset, increment = '0.00000000') {
    if (amt == 0)
    	return n(amt).format('0.00') + ' ' + asset
    return n(amt).format(increment) + ' ' + asset
  },
  ...
  formatCurrency: function formatCurrency (amt, currency, omit_currency, color_trick, do_pad, exponential) {
    let str
    let fstr
//    amt > 999 ? fstr = '0.00' :
//      amt > 99 ? fstr = '0.000' :
...
//            		  fstr = '0.00000000'
    amt > 9 ? fstr = '0.00' :
    	amt > 0.9 ? fstr = '0.0000' :
    		amt > 0.09 ? fstr = '0.00000' :
    			amt > 0.009 ? fstr = '0.000000' :
    				amt == 0 ? fstr = '0.00' :
    					fstr = '0.00000000'
