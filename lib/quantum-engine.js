...
//							if (on_hold && (s.balance.currency_hold > 0 || s.balance.asset_hold > 0)) {
							...
							if (n(s.available_balance.currency_hold).add(order_value).value() > 0 || s.available_balance.asset_hold > 0) {
								...
								debug.msg('s.available_balance.currency_hold= ' + s.available_balance.currency_hold + '; order_value= ' + order_value + '; s.available_balance.asset_hold= ' + s.available_balance.asset_hold, false)
