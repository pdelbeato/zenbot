...
module.exports = function (s, conf) {
	...
	function emitSignal (event, sig_type, signal, sig_id, fixed_size, fixed_price, is_reorder, is_taker) {
		eventBus.emit(event, sig_type, signal, sig_id, fixed_size, fixed_price, is_reorder, is_taker)
	}
