...
module.exports = function (s, conf) {
  ...
  function writeReport (is_progress, blink_off) {
    ...
    // }
      ...
      process.stdout.write(z(8, formatPercent(s.my_positions[position_max_profit_index].profit_pct, ' ')[s.my_positions[position_max_profit_index].profit_pct > 0 ? 'green' : 'red']))
    }
    else {
      process.stdout.write(z(9, '', ' '))
    }
