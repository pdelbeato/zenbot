...
//          executeSignal(s.signal)
        	...
        	// Con setTimeout, executeSignal viene eseguita dopo un valore random di massimo 1 secondo.
        	...
        	setTimeout(function() { executeSignal(s.signal) }, Math.floor(Math.random()*1000))
        	s.signal = null
        }
      }
    }
