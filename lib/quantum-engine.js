...
//Da sistemare: uso l'oggetto "position", ma mi sembra una toppa a colori
...
//				debug.msg('updateMessage - strategy result: ' + result)
	...
	return {
		update: onTrades,
		update_drain: function(cb) {
			tradeProcessingQueue.drain(cb())
		},
		exit: function (cb) {
...
//		tradeProcessing: function() {
//			return (tradeProcessingQueue.length() === 0 && tradeProcessingQueue.running() === 0)
//		},
