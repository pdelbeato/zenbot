...
//			s.acted_on_trend = false
		...
		syncBalance(function (err) {
			...
			debug.msg('executeSignal - Size:' + (n(fixed_size) || n(s.orders[signal][sig_type][sig_id].remaining_size) || n(so.quantum_size).divide(s.orders[signal][sig_type][sig_id].price)))
