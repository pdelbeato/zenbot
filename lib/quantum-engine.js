			...
			//...altrimenti continuo con i controlli
				...
				if (sig_id) {
					...
					if (s.positions[sig_id]) {
						...
						if (s.positions[sig_id].position_side == signal) {
							debug.msg('executeSignal - con sig_id. Annullo, perchè signal ' + signal + ' non coerente con la posizione (side = ' + s.positions[sig_id].position_side + ')')
							_cb && _cb(null, null)
							return
						}
