...
//						executeSignal(s.signal)
						...
						if (ora > (s.last_executeSignal + 1000)) {
							...
							debug.msg('onTrade - non chiamo executeSignal: ' + ora + ' < ' + s.last_executeSignal)
						}
						//Fine tentativo
					}
				}
