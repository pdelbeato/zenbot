...
//				}
				...
				if (s[signal + '_order'] && so.max_slippage_pct != null) {
					slippage = Math.abs(n(s[signal + '_order'].orig_price).subtract(price).divide(s[signal + '_order'].orig_price).multiply(100).value())
...
//************** Da sistemare questo punto. Considera solo buy.						
