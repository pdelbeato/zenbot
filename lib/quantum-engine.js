...
//			s.acted_on_trend = false
		...
		syncBalance(function (err) {
			...
			order_tmp.size = n(fixed_size || order_tmp.remaining_size || order_tmp.position.size || n(so.quantum_size).divide(order_tmp.price)).format(s.product.asset_increment ? s.product.asset_increment : '0.00000000', Math.floor)
...
//Controllare se buy_stop o sell_stop abbiano i segni + e - corretti.
