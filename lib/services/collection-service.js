...
var DatastoreMod = require('tingodb')().Db
...
//		'my_closed_positions'
	...
	convert_dir = conf.nestdb.dir + '_mod'
	db_mod.datastore = new DatastoreMod(convert_dir, {})
	...
	db_names_mod.forEach(function (db_name, index) {
		db_mod[db_name] = db_mod.datastore.collection(db_name);
	})

	console.log('Databases mod created/loaded.')

	_.set(conf, 'nestdb_mod', db_mod)
