      ...
      if (signal === 'buy') {
        ...
        if (!so.quantum_size) {
          ...
          if (is_reorder) {
            ...
            debug.msg('Calcolo buy_pct in quantum: ' + buy_pct + '% (' + s[signal + '_order'].remaining_size + '*' + price + '*100/' + s.balance.deposit + ')')
          } else {
            ...
            debug.msg('Calcolo buy_pct in quantum: ' + buy_pct + '% (' + so.quantum_size + '*100/' + s.balance.deposit + ')')
          }
        }
