...
withData(data, trades, options)
  ...
  <div  class="table-users">
    <div class="header">ID</div>
     <div class="header">Entry</div><div class="header">Exit</div>
     <div class="header">Exposure</div><div class="header">Profit</div>

     <table cellspacing="0">


        <tr>
           <td>End balance:</td><td>End balance:</td><td>End balance:</td>
